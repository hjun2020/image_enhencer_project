...
OBJ=gemm.o utils.o convolutional_layer.o list.o image.o im2col.o col2im.o blas.o data.o matrix.o network.o parser.o option_list.o activations.o layer.o batchnorm_layer.o
